...
pub struct InstallationRoleComparison {
    #[serde(rename = "comparison", skip_serializing_if = "Option::is_none")]
    pub comparison: Option<Comparison>,
    #[serde(rename = "remote", skip_serializing_if = "Option::is_none")]
    pub remote: Option<Box<crate::models::InstallationRole>>,
    #[serde(rename = "local", skip_serializing_if = "Option::is_none")]
    pub local: Option<Box<crate::models::InstallationRole>>,
}

impl InstallationRoleComparison {
    pub fn new() -> InstallationRoleComparison {
        InstallationRoleComparison {
            comparison: None,
            remote: None,
            local: None,
        }
